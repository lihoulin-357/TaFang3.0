...
Enemy::Enemy(WayPoint *startWayPoint, Scene *game, const QPixmap &sprite)
    : QObject(0)
    , m_active(false)
    , fire(0)
    , ice(0)
...
normalEnemy::normalEnemy(WayPoint *startWayPoint, Scene *game, const QPixmap &sprite)
...
iceEnemy::iceEnemy(WayPoint *startWayPoint, Scene *game, const QPixmap &sprite)
    :Enemy(startWayPoint, game,sprite)
{
    this->enemyKind=2;
    this->award=250;
...
fireEnemy::fireEnemy(WayPoint *startWayPoint, Scene *game, const QPixmap &sprite)
    :Enemy(startWayPoint, game,sprite)
{
    this->enemyKind=3;
    this->award=300;
...
fastEnemy::fastEnemy(WayPoint *startWayPoint, Scene *game, const QPixmap &sprite)
    :Enemy(startWayPoint, game,sprite)
{
    this->enemyKind=4;
    this->award=350;
...
bossEnemy::bossEnemy(WayPoint *startWayPoint, Scene *game, const QPixmap &sprite)
    :Enemy(startWayPoint, game,sprite)
{
    this->enemyKind=5;
    this->award=400;
